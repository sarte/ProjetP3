...
[solAr,solN2,solH2,solX]=solve(Ar+pu*(N2)/(78*(1-pu))==(X-pu*(X-xi))/(78*(1-pu)),N2+pu*(X-xi)==X,H2+pu*(3*X-3*xi)==3*X,Kc==((4*xi^2)*(4*X-2*xi+(X-pu*(X-xi))/(78*(1-pu)))^2)/((P^2)*(X-xi)*(3*X-3*xi)^3),Ar,N2,H2,X);
...
disp ('Flux entrant')
disp(['N2', solN2(2)/1000000*28])
disp (['H2',solH2(2)/1000000*2])
disp(['Ar', solAr(2)/1000000*40])
disp ('Flux sortant')
disp(['Ar', 0.01*solb/1000000*40])
