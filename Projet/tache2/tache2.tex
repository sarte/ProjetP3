...
Le Tableau \ref{Tableau} illustre la réaction incomplète prenant place dans le réacteur en prenant en compte le fait que les réactifs sont introduits de manière stœchiométrique. Le flux de \ce{NH3} produit étant un paramètre, le degré d'avancement $\xi$ de notre réaction n'est déjà plus une inconnue: $2\xi = F_{mol,\ce{NH3}_{out}}$. Il apparaît que le nombre total de gaz en réaction vaut $4X-2\xi+Y$.
...
La réaction de production d'ammoniac doit se faire à l'aide d'un catalyseur. Ce catalyseur permet d'accélérer la réaction. Il en existe différentes sortes, mais ils ont en général tous besoin d'une température minimale de \unit{400}{\celsius}
pour être efficaces.\cite{ib} Nous avons cependant commencé l'étude paramétrique à partir de la température ambiante, nous arrêtant à \unit{1400}{\kelvin} vu que le rendement est déjà quasiment nul à cette température.
