...
simulation faite avec \textsc{Aspen+}. Il s'agit d'un logiciel qui est utilisé dans l'industrie afin de modéliser des procédés 
...
\begin{figure}[ht!]
 \centering
 \includegraphics[scale=0.6]{Aspen.jpg}
