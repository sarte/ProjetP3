...
% p = pressure in the reacotor [bar]
% NH3P = molar flow of Ar entering the reactor [mol/day]
% Iv = accumulator. 
% It = iterator. Must begin with 0.
...
if It==Nit
    ...
    y(It)=Iv;
    x(It)=It;
    NH3Pf=syntheseRecursion(newN, newH,A,T,p,NH3P,newIv,It+1,Nit,x,y);
end
end
