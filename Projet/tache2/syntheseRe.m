...
% SyntheseRe calculates the amount of methane [t/day], water [t/day] and air [t/day] needed to produce M
% [t/day] of ammonia, in function of differents parameters:
% T[K], the temperature in the Primary Reformer.
% T2[K], the temperature in the Synthesis Reactor.
% p[bar], the pressure in the Synthesis Reactor
% pu, the purge percentage, for the Haber-Bosh process.
% 
...
%
% We used a bottom-up strategy: first calculate everything for the
% Synthesis Reactor, and then go back to the Primary Reformer.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% 1st part: Synthesis Reactor and reinjection %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

P=p;
xi=(M*(10^6))/(17.031)/2;
% reference values form nist.gov
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% 2nd part: Primary Reformer %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% reference values from nist.gov
