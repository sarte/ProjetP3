...
de $\ce{CH_4}$ et d'$\ce{H_2O}$, grâce à la relation $p\cdot \dot{V}=F_{x}\cdot R\cdot T$ où $F_{x}$ est le flux
molaire d'un composé x. Les deux composés se déplaçant simultanément dans les tuyaux, le nombre de tuyaux $N$ se trouve via la relation suivante:
...
$$N = (F_{\ce{CH_4}}+F_{\ce{H_2O}}) \cdot \dfrac{R \cdot T}{p \cdot \dot{V}}} = (3.8956\cdot 10^7+4.10957\cdot 10^7}}) \cdot \dfrac{8.31451 \cdot 1080}{30\cdot 10^5 \cdot1382.4}} = 173$$
