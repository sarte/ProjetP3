...
\begin{itemize}
	\item Soit $n_{\ce{CH4}}$ le nombre de moles de \ce{CH4} introduites dans le réacteur par jour.
	\item Soit $n_{\ce{H2O}}$ le nombre de moles d'\ce{H2O} introduites dans le réacteur par jour.
...
Au terme de ce procédé, nous aurons donc un débit molaire de prouction valant $1.56 \cdot n_{\text{air}}$ de \ce{NH3}. Cette
quantité est liée au débit molaire de \ce{CH4} introduites dans le réacteur (i.e. $n_{\ce{CH4}}$) par les deux équations obtenues plus haut:
\[
\left \{
\begin{array}
...
\right.
\]
En simplifiant, on obtient: $4 \cdot n_{\ce{CH4}} = 2.76 \cdot n_{\text{air}}$. Nous avons maintenant la quantité de \ce{CH4} introduite
...
Afin d'obtenir une relation avec le nombre de moles d'\ce{H2O} introduites dans le réacteur (i.e. $n_{\ce{H2O}}$), nous
