...
Au terme de ce procédé, nous aurons donc produit $1.56 \cdot n_{\text{air}}$ moles de \ce{NH3}. Cette quantité est liée au
nombre de moles de \ce{CH4} introduites dans le réacteur (i.e. $n_{\ce{CH4}}$) par les deux équations obtenues plus haut:
\[
\left \{
\begin{array}
...
\right.
\]
En simplifiant, on obtient: $4n_{\ce{CH4}} = 2.76 \cdot n_{\text{air}}$. Nous avons maintenant la quantité de \ce{CH4} introduite
